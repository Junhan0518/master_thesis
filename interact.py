...
def sample_sequence(history, tokenizer, model, args, SPECIAL_TOKENS, current_output=None):
    ...
    for i in range(args.max_length):
        instance, sequence = build_input_from_segments(history, current_output, tokenizer, SPECIAL_TOKENS, with_eos=False)
...
def run():
    ...
    model.load_state_dict(torch.load('logger/checkpoint_mymodel_171126.pt'))
