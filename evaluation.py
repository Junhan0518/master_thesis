...
def build_input_from_segments(topic, history, reply, tokenizer, SPECIAL_TOKENS, lm_labels=False, with_eos=True):
...
def run():
    ...
    model.load_state_dict(torch.load('full_logger/full_moodel._128.bin'))
